...
| [Вероятность покупки клиентом оборудования в компании](https://github.com/Nanobelka/R1_2800_features) | R1 Telecom | Компании R1 Telecom необходимо предсказывать вероятность покупки оборудования клиентом. Заказчик имеет собственное решение, но ищет пути его улучшения. Датасет включает около 2800 признаков.| Задача переформулирована так: автоматизировать отбор признаков при сохранении требуемого качества модели, чтобы заказчик мог существенно сократить ресурсы на регулярное обучение модели для поддержания ее качества. |
